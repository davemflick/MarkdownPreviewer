  ...
  handleTextChange: function(e){
	...
	render: function() {
      ...
      <div className='someContainer'>
  			<TextBoxWrapper header='Input' className="inputOutput editorContainer">
  			  <textarea className='editorInput' type='text' value={this.state.text} onChange={this.handleTextChange}>
  			 </textarea>
  			</TextBoxWrapper>
